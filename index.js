    ...
    try {
        ...
        fs.createReadStream(csvFilePath)
            ...
            .on('data', (data) => {
                ...
                // Handle NaN values by setting them to null or default value
            ...
            .on('end', async () => {
                console.log('Filtered CSV file data:', results);

                try {
                    // Use bulkWrite to handle upserts (update if exists, insert if not)
